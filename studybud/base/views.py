...
def loginPage(request):
    ...
    if request.method == 'POST':
        ...
        user = authenticate(request, username=username, password=password)  #user authentication, he exists
...
def room(request, pk):
    ...
    if request.method == 'POST':  #processing and displaying the new message
...
def updateRoom(request, pk):
    ...
    if request.user != room.host:
        return HttpResponse('you cant edit rooms you havnt created')
...
def deleteMessage(request, pk):
    ...
    if request.user != message.user:
        return HttpResponse ('you cant delete messages you havnt wrote')
